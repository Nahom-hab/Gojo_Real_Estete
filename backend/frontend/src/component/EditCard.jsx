...
export default function EditCard({ result, similar }) {
    ...
    return (
        <div className="bg-white border flex-none w-full  md:w-[220px] p-3 border-gray-200 rounded-lg shadow-lg cursor-pointer relative transition-transform duration-300 transform hover:scale-105">
            ...
            <div className="p-2">
                <div className="font-semibold text-black text-sm mb-1">{result.name}</div>
                <div className="text-gray-600 flex items-center mb-1 text-xs">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button
                                ...
                                className="bg-gray-300 px-4 py-2 text-sm rounded-lg transition-colors duration-300 hover:bg-gray-400"
                            >
                                Cancel
                            </button>
                        </div>
