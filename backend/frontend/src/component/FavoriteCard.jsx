...
export default function FavoriteCard({ result, similar }) {
    ...
    return (
        <div
            onClick={handleClick}
            className="bg-white dark:bg-gray-900 border flex-none w-[100%] dark:text-white md:w-[210px] p-2 dark:border-gray-600 border-gray-200 rounded-lg shadow-lg  cursor-pointer "
            role="button"
            tabIndex={0}
        ...
        >
            ...
            <div className="p-4 pb-1 pl-0 pt-1"> {/* Adjust padding */}
                ...
                <div className="text-gray-600 dark:text-gray-300 flex items-center mb-2 text-sm">
                ...
                <div className="flex gap-2 text-sm dark:text-gray-300 text-gray-600"> {/* Adjust font size */}
