...
const ThemeToggle = () => {
    ...
    return (
        <div className="fixed top-[24px] z-50 right-4 flex items-center">
            <button
            ...
            >
                <div
                    className={`absolute w-7 h-7 rounded-full bg-yellow-200 dark:bg-slate-950 shadow-md transform transition-transform duration-300 ${darkMode ? 'translate-x-7' : 'translate-x-0'
                        }`}
                />
                <FaSun
