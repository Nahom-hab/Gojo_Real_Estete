...
export default function Home() {
  ...
  return (
    <div className="relative mt-[-5px] pb-20 dark:bg-gray-800 bg-white">
      ...
      <div className='flex mt-10 justify-center'>
        <div className='w-[90%]'>
          ...
          <HorizontalScroller className='flex hover:cursor-pointer hover:text-blue-600 gap-2' />
        </div>
      </div>
      ...
      <div className='dark:bg-gray-800 bg-gray-50 p-7 md:flex space-y-3 justify-center gap-8 mt-10 pt-16 pb-16'>
        <div className='md:w-[360px] w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-black dark:text-white bg-white rounded-2xl gap-3 py-10 px-5 justify-center flex flex-col items-center shadow-[0_4px_20px_rgba(0,0,0,0.2)]'>
          ...
          <p className='text-center p-4  dark:text-gray-200 text-gray-700'>{isEng ? 'Find your place with an immersive photo experience and the listings, including things you won’t find anywhere else.' : 'ቦታዎን ይፈልጉ እንዲህ ያለ የፎቶ ማስታወቂያ ተመን እና የማስታወቂያዎች ጋር፣ በማንኛውም ሌላ ቦታ ማግኘት የማትችሉበት ነገር እንዲህ ያለው ይገኛል፡፡'}</p>
          <Link className='text-center' to={'/search'}>
            <button className='border border-black dark:border-gray-400 p-2 px-4 rounded-xl'>{isEng ? 'Browse homes' : 'ቤቶችን ይዘው ይቃኙ'}</button>
          </Link>
        </div>
        <div className='md:w-[360px] w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-black dark:text-white  bg-white rounded-2xl gap-3 py-10 px-5 justify-center flex flex-col items-center shadow-[0_4px_20px_rgba(0,0,0,0.2)]'>
          ...
          <Link className='text-center' to={'/sell'}>
            <button className='border border-black dark:border-gray-400 p-2 px-4 rounded-xl'>{isEng ? 'Get started' : 'መጀመር ይፈልጉ'}</button>
          </Link>
        </div>
        <div className='md:w-[360px] w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-black dark:text-white bg-white rounded-2xl gap-3 py-10 px-5 justify-center flex flex-col items-center shadow-[0_4px_20px_rgba(0,0,0,0.2)]'>
